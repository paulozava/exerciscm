...
t = '<p>This is a paragraph with # and * in the text</p><p>This is a paragraph with # and * in the text</p><li>Item 1 with a # in the text</li><li>Item 2 with * in the text</li><p>This is a paragraph with # and * in the text</p><p>This is a paragraph with # and * in the text</p><p>This is a paragraph with # and * in the text</p><li>Item 1 with a # in the text</li><li>Item 2 with * in the text</li><p>This is a paragraph with # and * in the text</p>'